...
from .alignment.similarity import estimate_similarity_backward_map
...
def _transfer_multiscale(
    ...
    for channel in range(3):
        ...
        warped_reference_residual = warp(
            reference_stack.residual, mapping, mode="border"
        )
...
def transfer_portrait_style(
    ...
    if resumed_from_stage in (None, RESUME_MULTISCALE):
        aligned_reference = warp(reference_crop, mapping, mode="border")
